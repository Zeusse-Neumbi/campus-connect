...
<div class="app-container">
    ...
    <div class="main-content">
        <div class="header glass-panel">
            ...
            <button onclick="generatePDF('${childUser.firstName.replace('\'', '\\\'')}', '${childUser.lastName.replace('\'', '\\\'')}')" class="btn btn-sm" style="background: #ef4444; color: white; margin-right: 1rem;">📄 Export PDF</button>
